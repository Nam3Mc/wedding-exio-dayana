...
export default (pool, auth) => {
  ...
  router.post('/', async (req, res) => {
    ...
    try {
      ...
      const insertInvitation = `
        INSERT INTO invitations (primary_guest, is_foreign, expiration_date, max_attendees, group_status)
        VALUES ($1, $2, $3, $4, 'PENDING')
        RETURNING id
      `;
      const values = [primary_guest, is_foreign || false, expiration_date, max_attendees || null];
  ...
  // DELETE – eliminar invitación (ON DELETE CASCADE elimina familiares)
